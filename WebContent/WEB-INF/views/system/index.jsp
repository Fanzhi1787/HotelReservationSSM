...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2022, Kyle, Ltd." />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;
	background:#FFFFFF;text-align :center;padding-top:6%;">
     <img src="../resources/admin/easyui/images/loading.jpg" width="30%">
</div> 
	<!-- begin of header -->
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="../home/index" target="_blank">首页<a href="logout" >退出登录</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
                	...
                	<c:forEach items="${secondMenuList }" var="secondMenu">
                		<c:if test="${secondMenu.parentId == topMenu.id }">
                			<li iconCls="${secondMenu.icon }">
								...
								data-link="${secondMenu.url }?_mid=${secondMenu.id }" iframe="1">${secondMenu.name }</a></li>
                    	</c:if>
                    </c:forEach>
                </ul>
            </div>
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2022【KyleJmi】 All Rights Reserved
    </div>
    <!-- end of footer -->  
    <script type="text/javascript">
		...
		//Name 添加菜单选项、Param title 名称、Param href 链接、Param iconCls 图标样式、Param iframe 链接跳转方式（true为iframe，false为href）

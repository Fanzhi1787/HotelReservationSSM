...
<head>
    <meta charset="UTF-8">
  <title>KyleJmi|酒店管理系统预定房间</title>
...
<div id="section">
    ...
    <div class="hotel_inf_w">
        ...
        <div class="hotel_roominfobox">
            <a href="#"><img src="${roomType.photo }" /></a>
            <div class="info">
            <h2>${roomType.name }</h2>
            </div>
    ...
    <div class="book_info">
        <form id="order_info">
            <ul>
                ...
                <li>
                    <div class="msg">
                        预定须知:请携带好本人的身份证，办理入住手续，本店办理入住需要在前台缴费押金 ￥100
                    </div>
                    <div id="btn_booking" style="float:right;margin-top:10px;">提交预定</div>

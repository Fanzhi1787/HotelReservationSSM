...
<html lang="zh-CN">
 ...
 <body>
       <header>
	          <div>
				<a href="index.html"><img src="../resources/home/images/logo2.png"></a> &nbsp;<span>会员登录</span>
			  </div>

	   </header>
       <section>
	        <div class="left">
			    <img src="../resources/home/images/shijiyuan.jpg" alt="">
			</div>
			<div class="login">
				...
				<button class="offset" id="bt_login">登 录</button>
			</div>
			<div class="reg">
			   <a href="reg">立即注册 &gt;&gt;</a>
			</div>
